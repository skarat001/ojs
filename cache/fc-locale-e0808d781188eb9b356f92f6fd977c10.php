<?php return array (
  ...
  'common.ccLicense' => '<br /><br />
		...
		<br/>
		Bekerja dibawah lisensi <a rel="license" target="_new" href="http://creativecommons.org/licenses/by/3.0/">Creative Commons Attribution 3.0  License</a>.',
  'common.ccLicense.rt' => '<div class="rtBlock">
		...
		<br />
		Bekerja dibawah lisensi <a rel="license" href="http://creativecommons.org/licenses/by/3.0/" target="_new">Creative Commons Attribution 3.0 License</a>.
	</div>',
  ...
  'notification.email' => 'Kirimi saya email untuk tipe notifikasi ini.',
  'notification.location' => 'Pergi ke URL',
  'notification.mailList' => 'Daftar surat menyurat notifikasi',
  'notification.mailList.emailInvalid' => 'Masukkan alamat email yang valid.',
  'notification.mailList.privacyProtection' => 'Kebijakan Perlindungan Privasi',
  'notification.mailList.protectedContent' => '<a href="{$subscribeUrl}">Langganan</a> ke konten yang dilindungi.',
  'notification.mailList.submit' => '<a href="{$submitUrl}">Kirim</a> artikel',
  'notification.mailList.register' => 'Anda dapat mendaftar dengan situs ini ke...',
  'notification.mailList.review' => 'Berpartisipasi di<a href="{$reviewUrl}">peer review</a> process',
  ...
  'notification.notificationsDescription' => 'Anda punya {$unreadCount} notifikasi yang belum dibaca dan  {$readCount} notifikasi yang sudah dibaca .  <a href="{$settingsUrl}">Klik di sini</a>untuk mengganti pengaturan notifikasi Anda.',
  ...
  'notification.subscribe' => 'Langganan',
  'notification.subscribeError' => 'Alamat email Anda telah berlangganan ke notifikasi ini.',
  'notification.subscribeSuccess' => 'Email telah terkirim ke alamat yang dituju. Silahkan klik tautan konfirmasi di email untuk bergabung dalam mailing list.',
  ...
  'notification.unsubscribe' => 'Tidak berlangganan',
  'notification.unsubscribeDescription' => 'Masukkan alamat email dan kata sandi Anda untuk tidak berlangganan dari notifikasi email. Jika Anda tidak ingat kata sandi Anda, tinggalkan bidang kata sandi kosong dan yang baru akan dikirimkan melalui email pada alamat email yang diberikan.',
  'notification.unsubscribeError' => 'Ada kesalahan saat proses tidak berlangganan. Pastikan alamat email dan kata sandi Anda benar.',
  'notification.unsubscribeSuccess' => 'Anda telah sukses tidak berlangganan.',
  'search.abstract' => 'Sari',
  'search.allFields' => 'Semua',

<?php return array (
  ...
  'user.email' => 'Email',
  'user.confirmEmail' => 'Konfirmasi Email',
  'user.fax' => 'Fax',
  'user.feminine' => 'P',
  'user.firstName' => 'Nama Depan',
  'user.gender' => 'Jenis Kelamin',
  'user.initialsExample' => 'Ratih Keumala Sari = RKS atau <a href=http://slametriyanto.net>Slamet Riyanto = SLM</a>',
  'user.initials' => 'Inisial',
  ...
  'user.login.rememberUsernameAndPassword' => 'Ingat nama pengguna dan kata sandi saya.',
  'user.login.resetPassword' => 'Atur ulang kata sandi',
  'user.logOut' => 'Log Out',
  'user.mailingAddress' => 'Alamat Surat Menyurat',
  'user.masculine' => 'L',
  'user.middleName' => 'Nama Tengah',
  ...
  'user.profile.form.firstNameRequired' => 'Nama depan diperlukan.',
  'user.profile.form.lastNameRequired' => 'Nama belakang diperlukan.',
  ...
  'user.register.form.usernameAlphaNumeric' => 'Nama pengguna bisa berisi hanya karakter alfanumerik, garis bawah, dan tanda penghubung, dan harus mulai dan berakhir dengan karakter alfanumerik.',

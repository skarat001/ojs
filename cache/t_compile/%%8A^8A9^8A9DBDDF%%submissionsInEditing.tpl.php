<?php /* Smarty version 2.6.26, created on 2016-06-19 09:29:28
         compiled from editor/submissionsInEditing.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sort_search', 'editor/submissionsInEditing.tpl', 15, false),array('function', 'translate', 'editor/submissionsInEditing.tpl', 16, false),array('function', 'sort_heading', 'editor/submissionsInEditing.tpl', 16, false),array('function', 'url', 'editor/submissionsInEditing.tpl', 39, false),array('function', 'page_info', 'editor/submissionsInEditing.tpl', 61, false),array('function', 'page_links', 'editor/submissionsInEditing.tpl', 62, false),array('block', 'iterate', 'editor/submissionsInEditing.tpl', 28, false),array('modifier', 'escape', 'editor/submissionsInEditing.tpl', 34, false),array('modifier', 'date_format', 'editor/submissionsInEditing.tpl', 36, false),array('modifier', 'truncate', 'editor/submissionsInEditing.tpl', 38, false),array('modifier', 'strip_tags', 'editor/submissionsInEditing.tpl', 39, false),)), $this); ?>
<div id="submissions">
...
</span><br /><?php echo $this->_plugins['function']['sort_heading'][0][0]->smartySortHeading(array('key' => "submissions.submit",'sort' => 'submithate'), $this);?>
</th>
		<th width="5%"><?php echo $this->_plugins['function']['sort_search'][0][0]->smartySortSearch(array('key' => "submissions.sec",'sort' => 'section'), $this);?>
</th>
		<th width="15%"><?php echo $this->_plugins['function']['sort_search'][0][0]->smartySortSearch(array('key' => "article.authors",'sort' => 'authors'), $this);?>
</th>
		<th width="25%"><?php echo $this->_plugins['function']['sort_search'][0][0]->smartySortSearch(array('key' => "article.title",'sort' => 'title'), $this);?>
</th>
		<th width="10%"><?php echo $this->_plugins['function']['sort_search'][0][0]->smartySortSearch(array('key' => "submission.copyedit",'sort' => 'subCopyedit'), $this);?>
</th>
		<th width="10%"><?php echo $this->_plugins['function']['sort_search'][0][0]->smartySortSearch(array('key' => "submission.layout",'sort' => 'subLayout'), $this);?>
</th>
		<th width="10%"><?php echo $this->_plugins['function']['sort_search'][0][0]->smartySortSearch(array('key' => "submissions.proof",'sort' => 'subProof'), $this);?>
</th>

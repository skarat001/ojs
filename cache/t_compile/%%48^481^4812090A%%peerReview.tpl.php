<?php /* Smarty version 2.6.26, created on 2016-06-20 04:55:24
         compiled from sectionEditor/submission/peerReview.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'sectionEditor/submission/peerReview.tpl', 12, false),array('function', 'url', 'sectionEditor/submission/peerReview.tpl', 25, false),array('function', 'icon', 'sectionEditor/submission/peerReview.tpl', 26, false),array('function', 'get_help_id', 'sectionEditor/submission/peerReview.tpl', 108, false),array('function', 'html_options_translate', 'sectionEditor/submission/peerReview.tpl', 424, false),array('modifier', 'assign', 'sectionEditor/submission/peerReview.tpl', 25, false),array('modifier', 'escape', 'sectionEditor/submission/peerReview.tpl', 26, false),array('modifier', 'strip_unsafe_html', 'sectionEditor/submission/peerReview.tpl', 42, false),array('modifier', 'concat', 'sectionEditor/submission/peerReview.tpl', 76, false),array('modifier', 'to_array', 'sectionEditor/submission/peerReview.tpl', 77, false),array('modifier', 'strip_tags', 'sectionEditor/submission/peerReview.tpl', 77, false),array('modifier', 'date_format', 'sectionEditor/submission/peerReview.tpl', 108, false),array('modifier', 'truncate', 'sectionEditor/submission/peerReview.tpl', 146, false),array('modifier', 'ord', 'sectionEditor/submission/peerReview.tpl', 185, false),array('modifier', 'chr', 'sectionEditor/submission/peerReview.tpl', 197, false),array('modifier', 'default', 'sectionEditor/submission/peerReview.tpl', 258, false),array('modifier', 'nl2br', 'sectionEditor/submission/peerReview.tpl', 310, false),)), $this); ?>
	<div id="submission">
...
" target="_blank"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['suppFile']->getRemoteURL())) ? $this->_run_mod_handler('truncate', true, $_tmp, 20, "...") : $this->_plugins['modifier']['truncate'][0][0]->smartyTruncate($_tmp, 20, "...")))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
				...
				<div class="form-group">
					...
					<input type="checkbox" name="show" id="show" class="form-control" value="1"<?php if ($this->_tpl_vars['suppFile']->getShowReviewers() == 1): ?> checked="checked"<?php endif; ?>/>
...
" class="btn btn-success"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.article.selectReviewer"), $this);?>
</a>&nbsp;&nbsp;
...
" class="btn btn-warning"><?php echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "sectionEditor.regrets.link"), $this))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp));?>
</a>
	</h4>
...
" class="btn btn-danger"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.article.clearReview"), $this);?>
</a>
...
" class="btn btn-danger"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.article.cancelReview"), $this);?>
</a>
		<?php endif; ?>
		</div>
			</div>
...
')"<?php endif; ?>><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.article.clearReviewForm"), $this);?>
	...
	<thead>
		<tr>
			<th class="inline" width="25%"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.request"), $this);?>
</th>
			<th class="inline" width="25%"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.underway"), $this);?>
</th>
			<th class="inline" width="25%"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.due"), $this);?>
</th>
			<th class="inline" width="25%"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.acknowledge"), $this);?>
</th>
		</tr>
		</thead>
		<tbody>
...
<?php else: ?>&mdash;<?php endif; ?></a>
	...
	<div class="row" >
		...
		<div class="col-md-3 ">
			...
			<strong>
	<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "reviewer.article.recommendation"), $this);?>
...
" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "reviewer.article.sendReminder"), $this);?>
	...
	<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "reviewer.competingInterests"), $this);?>


	<?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['reviewAssignment']->getCompetingInterests())) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : String::stripUnsafeHtml($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)))) ? $this->_run_mod_handler('default', true, $_tmp, "&mdash;") : smarty_modifier_default($_tmp, "&mdash;")); ?>
	...
	<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.reviewFormResponse"), $this);?>
...
');" class="icon"><?php echo $this->_plugins['function']['icon'][0][0]->smartyIcon(array('name' => 'comment'), $this);?>
	...
	<?php endif; ?>
	<?php if (! $this->_tpl_vars['reviewAssignment']->getReviewFormId() || $this->_tpl_vars['reviewAssignment']->getMostRecentPeerReviewComment()): ?>	<div class="row" >
...
<span class="inline">
			<strong>
			<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "reviewer.article.editorToEnter"), $this);?>
...
" class="btn btn-success btn-xs"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "reviewer.article.canDoReview"), $this);?>
...
" class="btn btn-warning btn-xs"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "reviewer.article.cannotDoReview"), $this);?>
</a><br />
			<?php endif; ?>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.article.recommendation"), $this);?>
	...
	<div class="row" >
		...
		<div class="col-md-3 ">
			...
			<strong>
			<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.article.rateReviewer"), $this);?>

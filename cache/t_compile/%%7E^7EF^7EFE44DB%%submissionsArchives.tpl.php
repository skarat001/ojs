<?php /* Smarty version 2.6.26, created on 2016-06-19 14:46:41
         compiled from editor/submissionsArchives.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sort_search', 'editor/submissionsArchives.tpl', 15, false),array('function', 'url', 'editor/submissionsArchives.tpl', 32, false),array('function', 'translate', 'editor/submissionsArchives.tpl', 36, false),array('function', 'print_issue_id', 'editor/submissionsArchives.tpl', 38, false),array('function', 'page_info', 'editor/submissionsArchives.tpl', 53, false),array('function', 'page_links', 'editor/submissionsArchives.tpl', 54, false),array('block', 'iterate', 'editor/submissionsArchives.tpl', 24, false),array('modifier', 'escape', 'editor/submissionsArchives.tpl', 28, false),array('modifier', 'date_format', 'editor/submissionsArchives.tpl', 29, false),array('modifier', 'truncate', 'editor/submissionsArchives.tpl', 31, false),array('modifier', 'strip_tags', 'editor/submissionsArchives.tpl', 32, false),)), $this); ?>
<div id="submissions">
...
<thead>
	<tr class="heading">
		...
		<th width="15%"><span class="disabled"></span><br /><?php echo $this->_plugins['function']['sort_search'][0][0]->smartySortSearch(array('key' => "submissions.submitted",'sort' => 'submithate'), $this);?>
</th>
		<th width="5%"><?php echo $this->_plugins['function']['sort_search'][0][0]->smartySortSearch(array('key' => "submissions.sec",'sort' => 'section'), $this);?>
</th>
		<th width="25%"><?php echo $this->_plugins['function']['sort_search'][0][0]->smartySortSearch(array('key' => "article.authors",'sort' => 'authors'), $this);?>
</th>
		<th width="30%"><?php echo $this->_plugins['function']['sort_search'][0][0]->smartySortSearch(array('key' => "article.title",'sort' => 'title'), $this);?>
</th>
		<th width="20%" align="right"><?php echo $this->_plugins['function']['sort_search'][0][0]->smartySortSearch(array('key' => "common.status",'sort' => 'status'), $this);?>
</th>
	</tr>
	</thead>
	<tbody>

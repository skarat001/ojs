<?php /* Smarty version 2.6.26, created on 2016-06-17 06:00:20
         compiled from author/submit/step1.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'author/submit/step1.tpl', 20, false),array('function', 'url', 'author/submit/step1.tpl', 24, false),array('function', 'fieldLabel', 'author/submit/step1.tpl', 50, false),array('function', 'html_options', 'author/submit/step1.tpl', 53, false),array('modifier', 'escape', 'author/submit/step1.tpl', 26, false),array('modifier', 'assign', 'author/submit/step1.tpl', 43, false),array('modifier', 'nl2br', 'author/submit/step1.tpl', 128, false),)), $this); ?>
...
" onsubmit="return checkSubmissionChecklist()" class="form-horizontal">
		<?php $_smarty_tpl_vars = $this->_tpl_vars;
...
" />
		...
		<?php else: ?>		<div id="section">
			...
			<div class="form-group">
				...
				<div class="col-md-5">
					<select name="sectionId" id="sectionId" size="1" class="form-control"><?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['sectionOptions'],'selected' => $this->_tpl_vars['sectionId']), $this);?>
</select>
				</div>
			</div>
...
" />
		...
		<?php else: ?>
			...
			<div class="form-group">
				<label class="col-md-3 control-label">
					<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'locale','required' => 'true','key' => "article.language"), $this);?>

				</label>
				<div class="col-md-5">
					<select name="locale" id="locale" size="1" class="selectMenu"><?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['supportedSubmissionLocaleNames'],'selected' => $this->_tpl_vars['locale']), $this);?>
</select>
				</div>
			</div>
...
<div class="col-md-3 control-label">
			...
			<div class="col-md-5">
			<textarea name="commentsToEditor" id="commentsToEditor" rows="3" cols="40" class="form-control"><?php echo ((is_array($_tmp=$this->_tpl_vars['commentsToEditor'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea>
		</div>
		</div>
...
" class="btn btn-default" onclick="<?php if ($this->_tpl_vars['articleId']): ?>confirmAction('<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'author'), $this);?>

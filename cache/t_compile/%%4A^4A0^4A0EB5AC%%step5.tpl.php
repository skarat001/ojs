<?php /* Smarty version 2.6.26, created on 2016-06-17 09:01:24
         compiled from author/submit/step5.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'author/submit/step5.tpl', 14, false),array('function', 'url', 'author/submit/step5.tpl', 16, false),array('function', 'call_hook', 'author/submit/step5.tpl', 85, false),array('modifier', 'escape', 'author/submit/step5.tpl', 17, false),array('modifier', 'to_array', 'author/submit/step5.tpl', 35, false),array('modifier', 'date_format', 'author/submit/step5.tpl', 38, false),)), $this); ?>
 ...
 ?>
		...
		<table class="table table-striped" width="100%">
			<thead>
				...
				<th width="10%"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.id"), $this);?>
</th>
				<th width="35%"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.originalFileName"), $this);?>
</th>
				<th width="25%"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.type"), $this);?>
</th>
				<th width="20%" class="nowrap"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.fileSize"), $this);?>
</th>
				<th width="10%" class="nowrap"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.dateUploaded"), $this);?>
</th>
			</tr>
		</thead>
		<tbody>

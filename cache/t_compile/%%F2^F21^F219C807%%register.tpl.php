<?php /* Smarty version 2.6.26, created on 2016-06-16 06:01:50
         compiled from user/register.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'user/register.tpl', 17, false),array('function', 'translate', 'user/register.tpl', 17, false),array('function', 'fieldLabel', 'user/register.tpl', 58, false),array('function', 'form_language_chooser', 'user/register.tpl', 61, false),array('function', 'html_options_translate', 'user/register.tpl', 185, false),array('function', 'html_options', 'user/register.tpl', 282, false),array('modifier', 'assign', 'user/register.tpl', 28, false),array('modifier', 'escape', 'user/register.tpl', 50, false),array('modifier', 'nl2br', 'user/register.tpl', 394, false),)), $this); ?>
		...
		<div class="form-group">
			<div class="row">
				<label class="col-md-3 control-label">
					<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'username','required' => 'true','key' => "user.username"), $this);?>
...
" id="username" size="20" maxlength="32" class="form-control" />
					<br>
					<?php if (! $this->_tpl_vars['existingUser']): ?>
					<small><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.register.usernameRestriction"), $this);?>
</small>
		...
		<div class="form-group">
			<label class="col-md-3 control-label">
				...
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'password','required' => 'true','key' => "user.password"), $this);?>
...
" id="password" size="20" class="form-control" />
				<br>
				<?php if (! $this->_tpl_vars['existingUser']): ?>
				<small><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.register.passwordLengthRestriction",'length' => $this->_tpl_vars['minPasswordLength']), $this);?>
</small>
		...
		<div class="form-group">
			<label class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'password2','required' => 'true','key' => "user.repeatPassword"), $this);?>
...
" size="20" class="form-control" />
		...
		<div class="form-group">
			<label class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'recaptcha_challenge_field','required' => 'true','key' => "common.captchaField"), $this);?>
				...
				<?php else: ?>
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'captcha','required' => 'true','key' => "common.captchaField"), $this);?>
...
" />
		...
		<?php endif; ?>		<div class="form-group">
			<label class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'salutation','key' => "user.salutation"), $this);?>
...
" size="20" maxlength="40" class="form-control" />
		...
		<div class="form-group">
			<label class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'firstName','required' => 'true','key' => "user.firstName"), $this);?>
...
" size="20" maxlength="40" class="form-control" />
		...
		<div class="form-group">
			<label class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'middleName','key' => "user.middleName"), $this);?>
...
" size="20" maxlength="40" class="form-control" />
		...
		<div class="form-group">
			<label class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'lastName','required' => 'true','key' => "user.lastName"), $this);?>
...
" size="20" maxlength="90" class="form-control" />
		...
		<div class="form-group">
			<label class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'initials','key' => "user.initials"), $this);?>
...
" size="5" maxlength="5" class="form-control" />&nbsp;&nbsp;
				<small><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.initialsExample"), $this);?>
</small>
		...
		<div class="form-group">
			<label class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => "gender-m",'key' => "user.gender"), $this);?>
		...
		<div class="form-group">
			<label class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'affiliation','key' => "user.affiliation"), $this);?>
...
]" rows="5" cols="40" class="form-control"><?php echo ((is_array($_tmp=$this->_tpl_vars['affiliation'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea><br/>
		...
		<div class="form-group">
			<label class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'signature','key' => "user.signature"), $this);?>
		...
		<div class="form-group">
			<label class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'email','required' => 'true','key' => "user.email"), $this);?>
...
" size="30" maxlength="90" class="form-control" /> <?php if ($this->_tpl_vars['privacyStatement']): ?><a class="action" href="#privacyStatement">
				<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.register.privacyStatement"), $this);?>
</a><?php endif; ?>
			</div>
		</div>
		...
		<div class="form-group">
			<label class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'confirmEmail','required' => 'true','key' => "user.confirmEmail"), $this);?>
...
" size="30" maxlength="90" class="form-control" />
		...
		<div class="form-group">
			<label class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'orcid','key' => "user.orcid"), $this);?>
...
" size="40" maxlength="255" class="form-control" /><br /><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.orcid.description"), $this);?>
		...
		<div class="form-group">
			<label class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'userUrl','key' => "user.url"), $this);?>
...
" size="30" maxlength="255" class="form-control" />
		...
		<div class="form-group">
			<label class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'phone','key' => "user.phone"), $this);?>
...
" size="15" maxlength="24" class="form-control" />
		...
		<div class="form-group">
			<label class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'fax','key' => "user.fax"), $this);?>
...
" size="15" maxlength="24" class="form-control" />
		...
		<div class="form-group">
			<label class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'mailingAddress','key' => "common.mailingAddress"), $this);?>
		...
		<div class="form-group">
			<label class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'country','key' => "common.country"), $this);?>
		...
		<div class="form-group">
			<label class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'biography','key' => "user.biography"), $this);?>
<br /><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.biography.description"), $this);?>
...
]" id="biography" rows="5" cols="40" class="form-control"><?php echo ((is_array($_tmp=$this->_tpl_vars['biography'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea>
			</div>
		</div>
		...
		<div class="form-group">
			<label class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'sendPassword','key' => "user.sendPassword"), $this);?>
		...
		<div class="form-group">
			<label class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.workingLanguages"), $this);?>
...
"<?php if (in_array ( $this->_tpl_vars['localeKey'] , $this->_tpl_vars['userLocales'] )): ?> checked="checked"<?php endif; ?> /> <?php echo ((is_array($_tmp=$this->_tpl_vars['localeName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
				...
				<div class="form-group">
					<label class="col-md-3 control-label">
						<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('suppressId' => 'true','name' => 'registerAs','key' => "user.register.registerAs"), $this);?>

					</label>
					<div class="col-md-5">
						<?php if ($this->_tpl_vars['allowRegReader'] || $this->_tpl_vars['allowRegReader'] === null): ?>
						<label for="registerAsReader">
							<input type="checkbox" name="registerAsReader" id="registerAsReader" value="1"<?php if ($this->_tpl_vars['registerAsReader']): ?> checked="checked"<?php endif; ?> /> 
							<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.reader"), $this);?>

						</label>: <small><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.register.readerDescription"), $this);?>
</small><br />
						<?php endif; ?>
						...
						<label for="openAccessNotification">
							<input type="checkbox" name="openAccessNotification" id="openAccessNotification" value="1"<?php if ($this->_tpl_vars['openAccessNotification']): ?> checked="checked"<?php endif; ?> /> <?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.reader"), $this);?>

						</label>: <small><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.register.openAccessNotificationDescription"), $this);?>
</small><br />
						<?php endif; ?>
						<?php if ($this->_tpl_vars['allowRegAuthor'] || $this->_tpl_vars['allowRegAuthor'] === null): ?>
						<label for="registerAsAuthor">
							<input type="checkbox" name="registerAsAuthor" id="registerAsAuthor" value="1"<?php if ($this->_tpl_vars['registerAsAuthor']): ?> checked="checked"<?php endif; ?> /> <?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.author"), $this);?>

						</label>:<small> <?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.register.authorDescription"), $this);?>
</small><br />
						<?php endif; ?>
						<?php if ($this->_tpl_vars['allowRegReviewer'] || $this->_tpl_vars['allowRegReviewer'] === null): ?>
						<label for="registerAsReviewer">
							<input type="checkbox" name="registerAsReviewer" id="registerAsReviewer" value="1"<?php if ($this->_tpl_vars['registerAsReviewer']): ?> checked="checked"<?php endif; ?> /> 
							<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.reviewer"), $this);?>

						</label>: <small><?php if ($this->_tpl_vars['existingUser']): ?>
						<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.register.reviewerDescriptionNoInterests"), $this);?>
...
<?php endif; ?></small>
		...
		<div class="form-group">
					<label class="col-md-3 control-label">
							<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.register.reviewerInterests"), $this);?>

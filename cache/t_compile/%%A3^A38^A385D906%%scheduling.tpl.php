<?php /* Smarty version 2.6.26, created on 2016-06-20 12:20:43
...
" method="post" class="form-horizontal">
		...
		<div class="col-md-3 control-label">
				<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.article.scheduleForPublication"), $this);?>
...
" class="btn btn-link"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "issue.toc"), $this);?>
</a>
					<?php else: ?>
...
<div class="row">
<div class="col-md-12">
	<small><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.article.payment.publicationFeeNotPaid"), $this);?>
</small>
</div>	
</div>
<div class="row">

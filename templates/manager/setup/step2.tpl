{**
	...
	*}
	...
	<form id="setupForm" method="post" action="{url op="saveSetup" path="2"}" class="form-horizontal">
	...
	<p>
		...
		{fieldLabel name="numWeeksPerReview" key="manager.setup.reviewOptions.numWeeksPerReview"}: <input type="text" name="numWeeksPerReview" id="numWeeksPerReview" value="{$numWeeksPerReview|escape}" size="2" maxlength="8" class="form-control" /> {translate key="common.weeks"}<br/>
...
<div id="editorDecision">
	...
	<div class="checkbox">
		<label for="notifyAllAuthorsOnDecision"><input type="checkbox" name="notifyAllAuthorsOnDecision" id="notifyAllAuthorsOnDecision" value="1"{if $notifyAllAuthorsOnDecision} checked="checked"{/if} /> <b>{translate key="manager.setup.notifyAllAuthorsOnDecision"}</b></label>
	</div>
...
<div id="addItemtoAboutJournal">
	...
	<div class="form-group">
		...
		<div class="col-md-2 col-sm-2">
			<input type="submit" name="delCustomAboutItem[{$aboutId|escape}]" value="{translate key="common.delete"}
	...
	<div class="form-group">
		<div class="col-md-offset-3 col-sm-offset-3">
			...
			<p><input type="submit" name="addCustomAboutItem" value="{translate key="manager.setup.addAboutItem"}" class="
				btn btn-primary" /></p>
			</div>
		</div>
	</div>
	...
	<div id="journalArchiving">
		...
		<div class="checkbox">
			<p><label for="enableLockss"><input type="checkbox" name="enableLockss" id="enableLockss" value="1"{if $enableLockss} checked="checked"{/if} /> <b>{translate key="manager.setup.lockssEnable" lockssUrl=$lockssUrl}</b></label></p>
		</div>
		<p>
	...
	<div id="reviewerDatabaseLink">
		...
		<table width="100%" class="data">
			...
			<div class="form-group">
				<div class="col-md-offset-3 col-sm-offset-3">
				<p><input type="submit" name="addReviewerDatabaseLink" value="{translate key="manager.setup.addReviewerDatabaseLink"}" class="btn btn-primary" /></p>
				</div>
			</div>
		</div>
		<br/>

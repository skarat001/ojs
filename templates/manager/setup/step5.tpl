...
<form id="setupForm" method="post" action="{url op="saveSetup" path="5"}" enctype="multipart/form-data" class="form-horizontal">
		...
		<div id="journalTitleAndLogo">
			...
			<div class="form-group">
				<div class="col-md-3 col-sm-3">
					<label>
						<input type="radio" name="homeHeaderTitleType[{$formLocale|escape}]" id="homeHeaderTitleType-0" value="0"{if not $homeHeaderTitleType[$formLocale]} checked="checked"{/if} /> {translate key="manager.setup.useTextTitle"}</label>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-md-7 col-sm-7">
						<input type="file" name="homeHeaderTitleImage" class="form-control" /> 
					</div>
					<div class="col-md-2 col-sm-2">
						<input type="submit" name="uploadHomeHeaderTitleImage" value="{translate key="common.upload"}" class="btn btn-primary" />
				...
				<div class="form-group">
					...
					<div class="col-md-7 col-sm-7">
						<input type="text" name="homeHeaderTitleImageAltText[{$formLocale|escape}]" value="{$homeHeaderTitleImageAltText[$formLocale]|escape}" size="40" maxlength="255" class="form-control" /></td>
			...
			<div id="journalLogoImage">
				...
				<table width="100%" class="data">
					<div class="form-group">
						...
						<div class="col-md-7 col-sm-7">
							<input type="file" name="homeHeaderLogoImage" id="homeHeaderLogoImage" class="form-control" />
						</div>
						<div class="col-md-2 col-sm-2">
							<input type="submit" name="uploadHomeHeaderLogoImage" value="{translate key="common.upload"}" class="btn btn-primary" />
						</div>
					</div>
				...
				<div id="journalThumbnail">
					...
					<div class="form-group">
						...
						<div class="col-md-7 cl-sm-7">
							<input type="file" name="journalThumbnail" id="journalThumbnail" class="form-control" />
						</div>
						<div class="col-md-2 cl-sm-2">
							<input type="submit" name="uploadJournalThumbnail" value="{translate key="common.upload"}" class="btn btn-primary" />
						</div>
					</div>
			...
			<div id="homepageImage">
				...
				<div class="form-group">
					...
					<div class="col-md-7 cl-sm-7">
						<input type="file" name="homepageImage" id="homepageImage" class="form-control" /> 
					</div>
					<div class="col-md-2 cl-sm-2">
						<input type="submit" name="uploadHomepageImage" value="{translate key="common.upload"}" class="btn btn-primary" />
					</div>
				</div>
			...
			<div id="journalPageHeaderInfo">
				...
				<div id="pageHeaderTitle">
					...
					<div class="form-group">
						...
						<div class="col-md-7 cl-sm-7">
							<input type="file" name="pageHeaderTitleImage" class="form-control" />
						</div>
						<div class="col-md-2 cl-sm-2">
				...
				<div id="journalLogo">
					...
					<div class="form-group">
						...
						<div class="col-md-7 cl-sm-7">
							<input type="file" name="pageHeaderLogoImage" id="pageHeaderLogoImage" class="form-control" /> 
						</div>
						<div class="col-md-2 cl-sm-2">
							<input type="submit" name="uploadPageHeaderLogoImage" value="{translate key="common.upload"}" class="btn btn-primary" />
						</div>
					</div>
				...
				<div id="journalFavicon">
					...
					<div class="form-group">
						...
						<div class="col-md-7 cl-sm-7">
							<input type="file" name="journalFavicon" id="journalFavicon" class="form-control" />
						</div>
						<div class="col-md-2 cl-sm-2">
							<input type="submit" name="uploadJournalFavicon" value="{translate key="common.upload"}" class="btn btn-primary" />
						</div>
					</div>
			...
			<div id="navigationBar">
				...
				<div class="form-group">
					...
					<div class="col-md-7 cl-sm-7">
						<input type="text" name="navItems[{$formLocale|escape}][{$navItemId|escape}][name]" id="navItems-{$navItemId|escape}-name" value="{$navItem.name|escape}" size="30" maxlength="90" class="form-control" /> 
						<div class="checkbox">
							<label for="navItems-{$navItemId|escape}-isLiteral"><input type="checkbox" name="navItems[{$formLocale|escape}][{$navItemId|escape}][isLiteral]" id="navItems-{$navItemId|escape}-isLiteral" value="1"{if $navItem.isLiteral} checked="checked"{/if} />
								{translate key="manager.setup.navItemIsLiteral"}</label>
							</div>
						</div>
						<div class="col-md-2 cl-sm-2">
					...
					<div class="form-group">
						...
						<div class="col-md-7 cl-sm-7">
							<input type="text" name="navItems[{$formLocale|escape}][{$navItemId|escape}][url]" id="navItems-{$navItemId|escape}-url" value="{$navItem.url|escape}" size="60" maxlength="255" class="form-control" /><div class="checkbox">
							<label for="navItems-{$navItemId|escape}-isAbsolute">
								...
								{translate key="manager.setup.navItemIsAbsolute"}</label>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-7 cl-sm-7">
							...
							<div class="checkbox">
								<label for="navItems-0-isLiteral">
									<input type="checkbox" name="navItems[{$formLocale|escape}][0][isLiteral]" id="navItems-0-isLiteral" value="1" />
							...
							<div class="col-md-7 cl-sm-7">
								...
								<div class="checkbox">
									<label for="navItems-0-isAbsolute">
										<input type="checkbox" name="navItems[{$formLocale|escape}][0][isAbsolute]" id="navItems-0-isAbsolute" value="1" />
						...
						<div id="journalLayout">
							...
							<div class="form-group">
								...
								<div class="col-md-7 cl-sm-7">
									<input type="file" name="journalStyleSheet" id="journalStyleSheet" class="form-control" /> 
								</div>
								<div class="col-md-2 cl-sm-2">
									<input type="submit" name="uploadJournalStyleSheet" value="{translate key="common.upload"}" class="btn btn-primary" />
								</div>
							</div>
						...
						<div id="setupInfo">
							...
							<div id="infoForReaders"><h4>{fieldLabel name="readerInformation" key="manager.setup.information.forReaders"}</h4>
								...
								<div id="infoForAuth"><h4>{fieldLabel name="authorInformation" key="manager.setup.information.forAuthors"}</h4>
									...
									<div class="form-group">
										<div class="col-md-offset-3 col-sm-offset-3">
										<p><input type="submit" onclick="prepBlockFields()" value="{translate key="common.saveAndContinue"}" class="btn btn-primary" /> <input type="button" value="{translate key="common.cancel"}" class="btn btn-warning" onclick="document.location.href='{url op="setup" escape=false}'" /></p>
										</div>
									</div>

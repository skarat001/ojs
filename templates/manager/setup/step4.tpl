{**
	...
	*}
	...
	<form id="setupForm" method="post" action="{url op="saveSetup" path="4"}" enctype="multipart/form-data" class="form-horizontal">
...
<div id="layoutAndGalleys">
	...
	<div id="layoutTemplates">
		...
		{fieldLabel name="template-file" key="manager.setup.layoutTemplates.file"}
			...
			<div class="col-md-5 col-sm-5">
		<input type="file" name="template-file" id="template-file" class="form-control" /><input type="submit" name="addTemplate" value="{translate key="common.upload"}" class="btn btn-primary" />
	</div>
		</div>
	</div><!-- layoutTemplates -->
